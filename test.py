...
cl = LINETCR.LINE()
cl.login(token="EpJBiuP7NTjEL7MR42Ja.OCTUHf+O8MrV6kxfKrHb/G.ApJjDTVKhD/7HlvwQXuk+gijXKqfoKD4m/Q/+0pICSA=")
cl.loginResult()

ki1 = LINETCR.LINE()
ki1.login(token="EoboBmfYNWv7GNq8fYW6.U7Gvr9sujvBq7JF8IAZ7nG.clLMD6nMZ6tWKhxNwfGVx0T8PjO4H4zsYRgBZxOG+Nc=")
ki1.loginResult()
...
ki10 = LINETCR.LINE()
ki10.login(token="EoZwaRCWrsIaoIy1xQta.gvkdf5H6cMllyS3Mf6HhAG./P2z1HYjwhLOl2kSWEWss+Brn+PMAdPJOKky7tpFh2U=")
ki10.loginResult()

print "login success"
reload(sys)
sys.setdefaultencoding('utf-8')
helpMessage ="""     ─┅═✥[By.มินทีมทดลองบอท]✥═┅─
...
targets = []
mid = cl.getProfile().mid
Bots = ["ua1cb6e845fe8f2646fe8a5c5911841fa",mid,Amid1,Amid2,Amid3,Amid4,Amid5,Amid6,Amid7,Amid8,Amid9,Amid10]
self = ["ua1cb6e845fe8f2646fe8a5c5911841fa",mid,Amid1,Amid2,Amid3,Amid4,Amid5,Amid6,Amid7,Amid8,Amid9,Amid10]
...
#==================================================
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ki.updateProfile(profile)
                        ...
                        ki1.sendText(msg.to,"[SELFBOT MIN HACK BOT]")
